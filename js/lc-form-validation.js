...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        var v = factory(__webpack_require__(35), exports);
	    ...
	    var FieldValidationResult = (function () {
	    ...
	    exports.FieldValidationResult = FieldValidationResult;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./baseFormValidation": 81,
		"./baseFormValidation.ts": 81,
		"./consts": 82,
		"./consts.ts": 82,
		"./entities": 13,
		"./entities.ts": 13,
		"./fieldValidationEventFilter": 83,
		"./fieldValidationEventFilter.ts": 83,
		"./index": 121,
		"./index.ts": 121,
		"./rules/email": 52,
		"./rules/email.ts": 52,
		...
		"./rules/length.ts": 53,
		"./rules/maxLength": 54,
		"./rules/maxLength.ts": 54,
		"./rules/minLength": 55,
		"./rules/minLength.ts": 55,
		"./rules/pattern": 56,
		"./rules/pattern.ts": 56,
		"./rules/required": 57,
		"./rules/required.ts": 57,
		"./rules/spec/email.spec": 58,
		"./rules/spec/email.spec.ts": 58,
		"./rules/spec/maxLength.spec": 59,
		"./rules/spec/maxLength.spec.ts": 59,
		"./rules/spec/minLength.spec": 60,
		"./rules/spec/minLength.spec.ts": 60,
		"./rules/spec/pattern.spec": 61,
		"./rules/spec/pattern.spec.ts": 61,
		"./rules/spec/required.spec": 62,
		"./rules/spec/required.spec.ts": 62,
		"./spec/baseFormValidation.spec": 84,
		"./spec/baseFormValidation.spec.ts": 84,
		"./spec/fieldValidationEventFilter.spec": 85,
		"./spec/fieldValidationEventFilter.spec.ts": 85,
		"./spec/validationEngine.spec": 86,
		"./spec/validationEngine.spec.ts": 86,
		"./spec/validationEngineValidateForm.spec": 87,
		"./spec/validationEngineValidateForm.spec.ts": 87,
		"./spec/validationEngineValidateSingleField.spec": 88,
		"./spec/validationEngineValidateSingleField.spec.ts": 88,
		"./spec/validationsDispatcher.spec": 89,
		"./spec/validationsDispatcher.spec.ts": 89,
		"./spec/validationsResultBuilder.spec": 90,
		"./spec/validationsResultBuilder.spec.ts": 90,
		"./validationEngine": 46,
		"./validationEngine.ts": 46,
		"./validationsDispatcher": 91,
		"./validationsDispatcher.ts": 91,
		"./validationsResultBuilder": 92,
		"./validationsResultBuilder.ts": 92
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(151), __webpack_require__(82), __webpack_require__(91), __webpack_require__(92), __webpack_require__(83)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    var validationsDispatcher_1 = require("./validationsDispatcher");
	    var validationsResultBuilder_1 = require("./validationsResultBuilder");
	    var fieldValidationEventFilter_1 = require("./fieldValidationEventFilter");
	    var ValidationEngine = (function () {
	        ...
	        ValidationEngine.prototype.isFormDirty = function () {
	            return !this.isFormChanged;
	        };
	        ValidationEngine.prototype.isFormPristine = function () {
	            return this.isFormChanged;
	        };
	        ValidationEngine.prototype.validateForm = function (viewModel) {
	            var _this = this;
	            var fullFormValidatedPromise = new core_js_1.Promise(function (resolve, reject) {
	                var fieldValidationResults = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(viewModel, Object.keys(_this.validationsPerField), _this.validateSingleField.bind(_this));
	                if (_this.validationsGlobalForm.length > 0) {
	                    fieldValidationResults = fieldValidationResults.concat(_this.validateGlobalFormValidations(viewModel));
	                }
	                core_js_1.Promise.all(fieldValidationResults)
	                    .then(function (fieldValidationResults) {
	                    var formValidationResult = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	        ...
	        ValidationEngine.prototype.validateGlobalFormValidations = function (vm) {
	            ...
	            if (this.validationsGlobalForm.length == 0) {
	                ...
	                var fieldValidationResultsPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, this.validationsGlobalForm);
	                this.asyncValidationInProgressCount--;
	                globalFieldResultValidations = fieldValidationResultsPromises.slice();
	            }
	            return globalFieldResultValidations;
	        };
	        ValidationEngine.prototype.triggerFieldValidation = function (vm, key, value, filters) {
	            if (filters === void 0) { filters = consts_1.consts.defaultFilter; }
	            this.isFormChanged = false;
	            return this.validateSingleField(vm, key, value, filters);
	        };
	        ValidationEngine.prototype.validateSingleField = function (vm, key, value, filters) {
	            var _this = this;
	            if (filters === void 0) { filters = null; }
	            this.asyncValidationInProgressCount++;
	            var fieldValidationResultPromise = new core_js_1.Promise(function (resolve, reject) {
	                if (!_this.isFieldKeyMappingDefined(key)) {
	                    _this.asyncValidationInProgressCount--;
	                    resolve();
	                }
	                else {
	                    var filteredFieldValidations = fieldValidationEventFilter_1.fieldValidationEventFilter.filter(_this.validationsPerField[key], filters);
	                    validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, filteredFieldValidations)
	                        .then(function (fieldValidationResult) {
	                        _this.asyncValidationInProgressCount--;
	        ...
	        ValidationEngine.prototype.addFieldValidation = function (key, validation, eventsFilter, customParams) {
	            if (eventsFilter === void 0) { eventsFilter = consts_1.consts.defaultFilter; }
	            if (customParams === void 0) { customParams = {}; }
	            var asyncValidationFn = function (value, vm, customParams) {
	                return core_js_1.Promise.resolve(validation(value, vm, customParams));
	            };
	        ...
	        ValidationEngine.prototype.isFieldKeyMappingDefined = function (key) {
	            return this.validationsPerField[key] !== undefined &&
	                this.validationsPerField[key] !== null;
	        };
	        ValidationEngine.prototype.addFormValidation = function (validation) {
	            var validationAsync = function (vm) {
	                return core_js_1.Promise.resolve(validation(vm));
	            };
	            this.validationsGlobalForm.push(validationAsync);
	        };
	        ValidationEngine.prototype.isValidationInProgress = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./required.ts": 57,
		"./spec/email.spec": 58,
		"./spec/email.spec.ts": 58,
		"./spec/maxLength.spec": 59,
		"./spec/maxLength.spec.ts": 59,
		"./spec/minLength.spec": 60,
		"./spec/minLength.spec.ts": 60,
		"./spec/pattern.spec": 61,
		"./spec/pattern.spec.ts": 61,
		"./spec/required.spec": 62,
		"./spec/required.spec.ts": 62
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./baseFormValidation.spec": 84,
		"./baseFormValidation.spec.ts": 84,
		"./fieldValidationEventFilter.spec": 85,
		"./fieldValidationEventFilter.spec.ts": 85,
		"./validationEngine.spec": 86,
		"./validationEngine.spec.ts": 86,
		"./validationEngineValidateForm.spec": 87,
		"./validationEngineValidateForm.spec.ts": 87,
		"./validationEngineValidateSingleField.spec": 88,
		"./validationEngineValidateSingleField.spec.ts": 88,
		"./validationsDispatcher.spec": 89,
		"./validationsDispatcher.spec.ts": 89,
		"./validationsResultBuilder.spec": 90,
		"./validationsResultBuilder.spec.ts": 90
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        var v = factory(__webpack_require__(47), exports);
	        if (v !== undefined) module.exports = v;
	    }
	    else if (true) {
	    ...
	    exports.email = function (value) {
	        var validationResult = new entities_1.FieldValidationResult();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    exports.parseLengthParams = parseLengthParams;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(53)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    function maxLength(value, vm, customParams) {
	        if (customParams === void 0) { customParams = DEFAULT_PARAMS; }
	        var length = length_1.parseLengthParams(customParams, BAD_PARAMETER);
	        var isValid = length_1.isLengthValid(value, length, isStringLengthValid);
	        var validationResult = new entities_1.FieldValidationResult();
	        validationResult.succeeded = isValid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    exports.minLength = function (value, vm, customParams) {
	        if (customParams === void 0) { customParams = DEFAULT_PARAMS; }
	        var length = length_1.parseLengthParams(customParams, BAD_PARAMETER);
	        var isValid = length_1.isLengthValid(value, length, isStringLengthValid);
	        var validationResult = new entities_1.FieldValidationResult();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    exports.required = function (value, vm, customParams) {
	        if (customParams === void 0) { customParams = DEFAULT_PARAMS; }
	        var validationResult = new entities_1.FieldValidationResult();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        var v = factory(__webpack_require__(67), exports);
	        if (v !== undefined) module.exports = v;
	    }
	    else if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(52)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var email_1 = require("../email");
	    describe('[email] validation rule tests =>', function () {
	        describe('When validating a non string value', function () {
	            it('should return false if value is null', function () {
	                var value = null;
	                var vm = undefined;
	                var customParams = undefined;
	                var validationResult = email_1.email(value, vm, customParams);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(54)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var maxLength_1 = require("../maxLength");
	    describe('[maxLength] validation rule tests =>', function () {
	        describe('When validating a non string value', function () {
	            it('should return true if value is undefined', function () {
	                var value = undefined;
	                var vm = undefined;
	                var customParams = { length: 4 };
	                var validationResult = maxLength_1.maxLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	            });
	        ...
	        describe('When validating a string value', function () {
	            it('should return true if value length is lesser than length option', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 6 };
	                var validationResult = maxLength_1.maxLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('MAX_LENGTH');
	                expect(validationResult.errorMessage).to.be.empty;
	            });
	            it('should return false if value length is greater than length option', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 2 };
	                var validationResult = maxLength_1.maxLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.false;
	                expect(validationResult.type).to.be.equals('MAX_LENGTH');
	                expect(validationResult.errorMessage).to.be.equals('The value provided is too long. Length must not exceed 2 characters.');
	            });
	            it('should return true if value length is equal than length option', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 4 };
	                var validationResult = maxLength_1.maxLength(value, vm, customParams);
	            ...
	            it('should return true if value length is 0 and length option is 0', function () {
	                var value = '';
	                var vm = undefined;
	                var customParams = { length: 0 };
	                var validationResult = maxLength_1.maxLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('MAX_LENGTH');
	                expect(validationResult.errorMessage).to.be.empty;
	        ...
	        describe('CustomParams boundaries =>', function () {
	            it('should throw an error if no length option is provided', function () {
	                var value = 't';
	                var vm = undefined;
	                var customParams = undefined;
	                var thrownErrorMessage = 'FieldValidationError: Parameter "length" for maxLength in customParams is mandatory and should be a valid number. Example: { length: 4 }.';
	                expect(maxLength_1.maxLength.bind(null, value, vm, customParams)).to.throw(Error, thrownErrorMessage);
	            });
	            it('should return false if length is not a valid number', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: null };
	                var thrownErrorMessage = 'FieldValidationError: Parameter "length" for maxLength in customParams is mandatory and should be a valid number. Example: { length: 4 }.';
	                expect(maxLength_1.maxLength.bind(null, value, vm, customParams)).to.throw(Error, thrownErrorMessage);
	            });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(55)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var minLength_1 = require("../minLength");
	    describe('[minLength] validation rule tests =>', function () {
	        describe('When validating a non string value', function () {
	            it('should return true if value is undefined', function () {
	                var value = undefined;
	                var vm = undefined;
	                var customParams = { length: 4 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	        ...
	        describe('When validating a string value', function () {
	            it('should return false for empty strings', function () {
	                var value = '';
	                var vm = undefined;
	                var customParams = { length: 3 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.false;
	                expect(validationResult.errorMessage).to.be.equals('The value provided must have at least 3 characters.');
	                expect(validationResult.type).to.be.equals('MIN_LENGTH');
	            });
	            it('should return true if value length is greater than length option', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 2 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	            ...
	            it('should return false if value length is lesser than length option', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 6 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	            ...
	            it('should return true if value has length greater than 0 and length option is 0', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: 0 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	            ...
	            it('should return true if valuehas length of 0 and length option is 0', function () {
	                var value = '';
	                var vm = undefined;
	                var customParams = { length: 0 };
	                var validationResult = minLength_1.minLength(value, vm, customParams);
	        ...
	        describe('CustomParams boundaries =>', function () {
	            it('should throw an error if no length option is provided', function () {
	                ...
	                var vm = undefined;
	                var customParams = undefined;
	                var thrownErrorMessage = 'FieldValidationError: Parameter "length" for minLength in customParams is mandatory and should be a valid number. Example: { length: 4 }.';
	                expect(minLength_1.minLength.bind(null, value, vm, customParams)).to.throw(Error, thrownErrorMessage);
	            });
	            it('should return false if length option is null', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { length: null };
	                var thrownErrorMessage = 'FieldValidationError: Parameter "length" for minLength in customParams is mandatory and should be a valid number. Example: { length: 4 }.';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    describe('[pattern] validation rule tests =>', function () {
	        describe('Pattern option boundaries =>', function () {
	            it('should throw an error if pattern is null', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { pattern: null };
	                var thrownErrrorMessage = 'FieldValidationError: pattern option for pattern validation is mandatory. Example: { pattern: /\d+/ }.';
	                expect(pattern_1.pattern.bind(null, value, vm, customParams)).to.throw(Error, thrownErrrorMessage);
	            });
	            it('should throw an error if pattern is boolean', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { pattern: false };
	                var thrownErrrorMessage = 'FieldValidationError: pattern option for pattern validation is mandatory. Example: { pattern: /\d+/ }.';
	                expect(pattern_1.pattern.bind(null, value, vm, customParams)).to.throw(Error, thrownErrrorMessage);
	            });
	        });
	        describe('Given a string as RegExp in pattern option', function () {
	            it('should not use the entire pattern as a complete pattern', function () {
	                var value = 'Some tests needed';
	                var vm = undefined;
	                var customParams = { pattern: 'tests' };
	                var validationResult = pattern_1.pattern(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('PATTERN');
	                expect(validationResult.errorMessage).to.be.empty;
	            });
	            it('should return true for a value that matches pattern', function () {
	                var value = 'test';
	                var vm = undefined;
	                var customParams = { pattern: 'test' };
	                var validationResult = pattern_1.pattern(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('PATTERN');
	                expect(validationResult.errorMessage).to.be.empty;
	        ...
	        describe('Given a RegExp object in pattern option', function () {
	            it('should return true if field value matches the given pattern', function () {
	                var value = 'Some tests needed';
	                var vm = undefined;
	                var customParams = { pattern: /tests/ };
	                var validationResult = pattern_1.pattern(value, vm, customParams);
	            ...
	            it('should return false if field value does not match the given pattern', function () {
	                var value = 'Some tests needed';
	                var vm = undefined;
	                var customParams = { pattern: /^tests/ };
	                var validationResult = pattern_1.pattern(value, vm, customParams);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(57)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var required_1 = require("../required");
	    describe('[required] validation rule tests =>', function () {
	        describe('When validating a non string value', function () {
	            it('should return false if value is null', function () {
	                var value = null;
	                var vm = undefined;
	                var customParams = undefined;
	                var validationResult = required_1.required(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.false;
	        ...
	        describe('When validating a string value', function () {
	            ...
	            it('should return true if string has whitespace characters and trim option is false', function () {
	                var value = ' ';
	                var vm = undefined;
	                var customParams = { trim: false };
	                var validationResult = required_1.required(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('REQUIRED');
	                expect(validationResult.errorMessage).to.be.empty;
	            });
	            it('should return true if string has whitespace characters and trim option is null', function () {
	                var value = ' ';
	                var vm = undefined;
	                var customParams = { trim: null };
	                var validationResult = required_1.required(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('REQUIRED');
	                expect(validationResult.errorMessage).to.be.empty;
	            });
	            it('should return true if string has whitespace characters and trim option is undefined', function () {
	                var value = ' ';
	                var vm = undefined;
	                var customParams = { trim: undefined };
	                var validationResult = required_1.required(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.true;
	                expect(validationResult.type).to.be.equals('REQUIRED');
	                expect(validationResult.errorMessage).to.be.empty;
	            });
	            it('should return false if string has whitespace characters and trim option is true', function () {
	                var value = ' ';
	                var vm = undefined;
	                var customParams = { trim: true };
	                var validationResult = required_1.required(value, vm, customParams);
	                expect(validationResult.succeeded).to.be.false;
	                expect(validationResult.type).to.be.equals('REQUIRED');
	                expect(validationResult.errorMessage).to.be.equals('Please fill in this mandatory field.');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(57), __webpack_require__(55), __webpack_require__(54), __webpack_require__(52), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    exports.Validators = {
	        ...
	        maxLength: maxLength_1.maxLength,
	        email: email_1.email,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./email.spec.ts": 58,
		"./maxLength.spec": 59,
		"./maxLength.spec.ts": 59,
		"./minLength.spec": 60,
		"./minLength.spec.ts": 60,
		"./pattern.spec": 61,
		"./pattern.spec.ts": 61,
		"./required.spec": 62,
		"./required.spec.ts": 62
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(46)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    var BaseFormValidation = (function () {
	        ...
	        BaseFormValidation.prototype.parseValidationConstraints = function (validationConstraints) {
	            if (validationConstraints && typeof validationConstraints === 'object') {
	                var global = validationConstraints.global, fields = validationConstraints.fields;
	        ...
	        BaseFormValidation.prototype.parseFormValidations = function (validationFunctions) {
	            var _this = this;
	        ...
	        BaseFormValidation.prototype.parseAllFieldsValidations = function (fields) {
	            for (var field in fields) {
	                this.parseFieldValidations(field, fields[field]);
	            }
	        };
	        BaseFormValidation.prototype.parseFieldValidations = function (constraint, fieldValidationConstraints) {
	            var _this = this;
	            if (fieldValidationConstraints instanceof Array) {
	                fieldValidationConstraints.forEach(function (fieldValidationConstraint) {
	                    if (fieldValidationConstraint && typeof fieldValidationConstraint === 'object') {
	                        _this.addFieldValidation(constraint, fieldValidationConstraint);
	                    }
	                });
	            }
	        };
	        BaseFormValidation.prototype.addFieldValidation = function (field, validationConstraint) {
	        ...
	        BaseFormValidation.prototype.validateField = function (vm, key, value, eventsFilter) {
	            return this.validationEngine.triggerFieldValidation(vm, key, value, eventsFilter);
	        };
	        BaseFormValidation.prototype.validateForm = function (vm) {
	            return this.validationEngine.validateForm(vm);
	        };
	        BaseFormValidation.prototype.isValidationInProgress = function () {
	            return this.validationEngine.isValidationInProgress();
	        };
	        BaseFormValidation.prototype.isFormDirty = function () {
	            return this.validationEngine.isFormDirty();
	        };
	        BaseFormValidation.prototype.isFormPristine = function () {
	            return this.validationEngine.isFormPristine();
	        };
	        return BaseFormValidation;
	    }());
	    exports.BaseFormValidation = BaseFormValidation;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    var FieldValidationEventFilter = (function () {
	        ...
	        FieldValidationEventFilter.prototype.filter = function (fieldValidations, eventsFilter) {
	            var _this = this;
	            var result = [];
	            if (eventsFilter) {
	        ...
	        FieldValidationEventFilter.prototype.hasAnyFilter = function (fieldValidation, eventsFilter) {
	    ...
	    exports.fieldValidationEventFilter = new FieldValidationEventFilter();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        var v = factory(__webpack_require__(48), exports);
	        if (v !== undefined) module.exports = v;
	    }
	    else if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(81), __webpack_require__(13), __webpack_require__(46)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var baseFormValidation_1 = require("../baseFormValidation");
	    var entities_1 = require("../entities");
	    var validationEngine_1 = require("../validationEngine");
	    describe('formValidation tests', function () {
	        describe('Group#1 => BaseFormValidation tests', function () {
	            it('Spec#1 => should return an instance of Formvalidation', function () {
	                var validationConstraints = {};
	                var formValidation = new baseFormValidation_1.BaseFormValidation(validationConstraints);
	                expect(formValidation).to.be.an('object').that.is.not.null;
	                expect(formValidation).to.be.an.instanceOf(baseFormValidation_1.BaseFormValidation);
	            });
	            it('Spec#2 => should have an exposed method "isFormDirty" that calls ValidationEngine.isFormDirty', sinon.test(function () {
	                var sinon = this;
	                var isFormDirty = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'isFormDirty', function () { });
	                var validationConstraints = {};
	                var formValidation = new baseFormValidation_1.BaseFormValidation(validationConstraints);
	            ...
	            it('Spec#3 => should have an exposed method "validateField" that calls ValidationEngine.validateSingleField', sinon.test(function () {
	                var sinon = this;
	                var validateSingleField = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'validateSingleField', function () { });
	                var validationConstraints = {};
	                var viewModel = {};
	                var key = 'fullname';
	                var value = '';
	                var eventsFilter = undefined;
	                var formValidation = new baseFormValidation_1.BaseFormValidation(validationConstraints);
	            ...
	            it('Spec#4 => should have an exposed method "validateForm" that calls ValidationEngine.validateForm', sinon.test(function () {
	                var sinon = this;
	                var validateForm = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'validateForm', function () { });
	                var validationConstraints = {};
	                var viewModel = {};
	                var formValidation = new baseFormValidation_1.BaseFormValidation(validationConstraints);
	            ...
	            it('Spec#5 => should have an exposed method "isValidationInProgress" that calls ValidationEngine.isValidationInProgress', sinon.test(function () {
	                var sinon = this;
	                var isValidationInProgress = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'isValidationInProgress', function () { });
	                var validationConstraints = {};
	                var formValidation = new baseFormValidation_1.BaseFormValidation(validationConstraints);
	        ...
	        describe('Group#2 => createFormValidation tests', function () {
	            it('Spec#1 => should return an instance of BaseFormValidation', function () {
	                var validationConstraints = {};
	                var formValidation = baseFormValidation_1.createFormValidation(validationConstraints);
	                expect(formValidation).to.be.an('object').that.is.an.instanceOf(baseFormValidation_1.BaseFormValidation);
	            });
	        });
	        describe('Group#3 => createFormValidation ValidationConstraints.global object boundaries', function () {
	            it('Spec #1 => should not add global validations with null value', sinon.test(function () {
	                var sinon = this;
	                var validationConstraints = null;
	                var addFormValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFormValidation', function () { });
	                baseFormValidation_1.createFormValidation(validationConstraints);
	            ...
	            it('Spec #8 => should not add global validations if global object is not an array of functions', sinon.test(function () {
	                var sinon = this;
	                var addFormValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFormValidation', function () { });
	                var validationConstraints1 = {
	                    global: null
	                };
	                var validationConstraints2 = {
	                    global: [null]
	                };
	                baseFormValidation_1.createFormValidation(validationConstraints1);
	                baseFormValidation_1.createFormValidation(validationConstraints2);
	                expect(addFormValidation.called).to.be.false;
	            }));
	            it('Spec #9 => should not add global validations if global object is an array of functions', sinon.test(function () {
	                ...
	                var validationConstraints = {
	                    global: [
	                        function (vm) { return new entities_1.FieldValidationResult(); },
	                        function (vm) { return new entities_1.FieldValidationResult(); },
	                        function (vm) { return new entities_1.FieldValidationResult(); },
	                    ]
	                };
	        ...
	        describe('Group #4 => createFormValidation ValidationConstraints.fields object boundaries', function () {
	            it('should not add a field validations given a non object', sinon.test(function () {
	                var sinon = this;
	                var addFieldValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFieldValidation', function () { });
	                var validationConstraints = {
	                    fields: 'test'
	                };
	                var formValidation = baseFormValidation_1.createFormValidation(validationConstraints);
	            ...
	            it('should not add field validations given a FieldValidationConstraint array of non objects', sinon.test(function () {
	                var sinon = this;
	                var addFieldValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFieldValidation', function () { });
	                var validation1 = function () { return new entities_1.FieldValidationResult(); };
	                var validationConstraints = {
	                    fields: {
	                        fullname: [undefined, 'foo'],
	                    }
	                };
	                var formValidation = baseFormValidation_1.createFormValidation(validationConstraints);
	            ...
	            it('should add field validations given an FieldValidationConstraint with {validator: <function>}', sinon.test(function () {
	                ...
	                var addFieldValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFieldValidation', function () { });
	                var validation1 = function () { return new entities_1.FieldValidationResult(); };
	                var validation2 = function () { return new entities_1.FieldValidationResult(); };
	                var eventsFilter = undefined;
	                var customParams = undefined;
	                var validationConstraints = {
	                    fields: {
	            ...
	            it('should pass FieldValidationConstraints to ValidationEngine', sinon.test(function () {
	                ...
	                var addFieldValidation = sinon.stub(validationEngine_1.ValidationEngine.prototype, 'addFieldValidation', function () { });
	                var validation1 = function () { return new entities_1.FieldValidationResult(); };
	                var customParams = { foo: 'bar' };
	                var eventsFilter = { OnBlur: true };
	                var validationConstraints = {
	                    fields: {
	                        property1: [
	                            {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var fieldValidationEventFilter_1 = require("../fieldValidationEventFilter");
	    describe('FieldValidationEventFilter ', function () {
	        describe('when calling filter ', function () {
	            it('should returns new Array<FieldValidation> having only one elmenent matching the eventsFilter {OnChange: true} ' +
	                'when passing a list of validations containg only one Element and having OnChange true for that element', function () {
	                var allValidations = [
	                    {
	                        validationFn: function (vm, value) { return null; },
	                        eventsFilter: { OnChange: true },
	                        customParams: {}
	                    }
	                ];
	                var eventFilter = { OnChange: true };
	                var result = fieldValidationEventFilter_1.fieldValidationEventFilter.filter(allValidations, eventFilter);
	        ...
	        describe('when calling filter ', function () {
	            it('should returns new Array<FieldValidation> having zero elmenent matching the eventsFilter {OnBlur: true} ' +
	                ...
	                var eventsFilter = { OnBlur: true };
	                var result = fieldValidationEventFilter_1.fieldValidationEventFilter.filter(allValidations, eventsFilter);
	        ...
	        describe('FieldValidationEventFilter ', function () {
	            describe('when calling filter ', function () {
	                it('should returns new Array<FieldValidation> having only one elmenent matching the eventsFilter {OnChange: true} ' +
	                    'when passing a list of validations containg two elements, one OnChange the other OnBlur', function () {
	                    var allValidations = [
	                        {
	                            validationFn: function (vm, value) { return null; },
	                            eventsFilter: { OnChange: true },
	                    ...
	                    var eventsFilter = { OnChange: true };
	                    var result = fieldValidationEventFilter_1.fieldValidationEventFilter.filter(allValidations, eventsFilter);
	                    expect(result.length).to.be.equal(1);
	                    expect(result[0].eventsFilter.OnChange).to.be.true;
	                });
	        ...
	        describe('FieldValidationEventFilter ', function () {
	            describe('when calling filter ', function () {
	                it('should returns new Array<FieldValidation> having two  elements matching the eventsFilter {OnChange: true} ' +
	                    'when passing a list of validations containg three elements, two OnChange the other OnBlur', function () {
	                    var allValidations = [
	                        {
	                            validationFn: function (vm, value) { return null; },
	                            eventsFilter: { OnChange: true },
	        ...
	        describe('FieldValidationEventFilter ', function () {
	            describe('when calling filter ', function () {
	                it('should returns new Array<FieldValidation> having two  elements matching the eventsFilter {OnChange: true, OnBlur: true} (OR) ' +
	                    'when passing a list of validations containg three elements, one OnChange the other OnBlur, the other OnWhatever', function () {
	                    var allValidations = [
	                        {
	                            validationFn: function (vm, value) { return null; },
	                            eventsFilter: { OnChange: true },
	                    ...
	                    var eventsFilter = { OnChange: true, OnBlur: true };
	                    var result = fieldValidationEventFilter_1.fieldValidationEventFilter.filter(allValidations, eventsFilter);
	                    expect(result.length).to.be.equal(2);
	                    expect(result[0].eventsFilter.OnChange).to.be.true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(46), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var validationEngine_1 = require("../validationEngine");
	    var entities_1 = require("../entities");
	    describe('ValidationEngine tests', function () {
	        it('should return isFormPristine true after initialization', function () {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            expect(formValidationBase.isFormPristine()).to.be.true;
	        });
	        it('should return isFormPristine false after initialization and set value field', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = [{ formFieldName: 'nameId', vmFieldName: 'name' }];
	            formValidationBase
	        ...
	        it('should return isFormDirty false after initiazalition', function () {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            expect(formValidationBase.isFormDirty()).to.be.false;
	        });
	        it('should return isFormDirty true after initialization and set value field', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = [{ formFieldName: 'nameId', vmFieldName: 'name' }];
	            formValidationBase
	                .triggerFieldValidation(viewModel, 'nameId', 'newContent')
	        ...
	        it('should return isValidationInProgress false after initialization', function () {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            expect(formValidationBase.isValidationInProgress()).to.be.false;
	        });
	        it('should return isValidationInProgress false if no validations are defined', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = [{ formFieldName: 'nameId', vmFieldName: 'name' }];
	            formValidationBase
	                .triggerFieldValidation(viewModel, 'nameId', 'newContent')
	        ...
	        it('should returns isFieldKeyMappingDefined equals false ' +
	            'when passing a key equals undefined and validationsPerField equals []', function () {
	            var key = undefined;
	            var validationEngine = new validationEngine_1.ValidationEngine();
	            var result = validationEngine.isFieldKeyMappingDefined(key);
	            expect(result).to.be.false;
	        });
	        it('should returns isFieldKeyMappingDefined equals false ' +
	            'when passing a key equals null and validationsPerField equals []', function () {
	            var key = null;
	            var validationEngine = new validationEngine_1.ValidationEngine();
	            var result = validationEngine.isFieldKeyMappingDefined(key);
	            expect(result).to.be.false;
	        ...
	        it('should returns isFieldKeyMappingDefined equals false ' +
	            'when passing a key equals "test" and validationsPerField equals []', function () {
	            var key = "test";
	            var validationEngine = new validationEngine_1.ValidationEngine();
	            var result = validationEngine.isFieldKeyMappingDefined(key);
	            expect(result).to.be.false;
	        ...
	        it('should returns isFieldKeyMappingDefined equals false ' +
	            'when passing a key equals "test1" and validationsPerField equals ["test2": validationFn]', function () {
	            var key = "test1";
	            var validationFn = function (value, vm) {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	        ...
	        it('should returns isFieldKeyMappingDefined equals true ' +
	            'when passing a key equals "test" and validationsPerField equals ["test": validationFn]', function () {
	            var key = "test";
	            var validationFn = function (value, vm) {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	                return Promise.resolve(fieldValidationResult);
	        ...
	        it('should return itself after adding a validation rule using addFieldValidation method', function () {
	            var key = 'test1';
	            var validationFn = function (value, vm) {
	                return new entities_1.FieldValidationResult();
	            };
	            var validationEngine = new validationEngine_1.ValidationEngine();
	            var result = validationEngine.addFieldValidation(key, validationFn);
	            expect(result).not.to.be.undefined;
	            expect(result).to.be.an.instanceOf(validationEngine_1.ValidationEngine);
	        });
	        it('should return itself after adding a validation rule using addFieldValidation method', function () {
	            var key = 'test1';
	            var validationFn = function (value, vm) {
	                return Promise.resolve(new entities_1.FieldValidationResult());
	            };
	            var validationEngine = new validationEngine_1.ValidationEngine();
	            var result = validationEngine.addFieldValidation(key, validationFn);
	            expect(result).not.to.be.undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    var validationEngine_1 = require("../validationEngine");
	    var entities_1 = require("../entities");
	    describe('ValidationEngine Validate Form', function () {
	        describe('Group #1 => When calling validateForm and addFieldValidation', function () {
	            it('Spec #1 => should return a failed FormValidationResult with one fieldErrors equals ' +
	                ...
	                ' when passing one validation rule with key equals "fullname" and viewModel equals { id: "1", fullname: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	                    validationResult.type = "REQUIRED";
	                ...
	                validationEngine.validateForm(viewModel)
	                    .then(function (formValidationResult) {
	            ...
	            it('Spec #2 => should return a succeeded FormValidationResult with one fieldErrors equals ' +
	                ...
	                'equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #3 => should return a failed FormValidationResult with two fieldErrors first equals ' +
	                ...
	                'equals "password" and viewModel equals { id: "1", fullname: "", password: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', password: '' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	                ...
	                validationEngine.addFieldValidation('password', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	                    validationResult.type = "REQUIRED";
	                ...
	                validationEngine.addFieldValidation('password', function (value) {
	                    var minLength = (value != null && value.length >= 3);
	                    var errorInfo = (minLength) ? "" : "Password must be at least 3 characters";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #4 => should return a failed FormValidationResult with two fieldErrors ' +
	                ...
	                'When passing one validation rule with key equals "fullname", two validations rules with key ' +
	                'equals "password" and viewModel equals { id: "1", fullname: "", password: "1" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', password: '1' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #5 => should return a failed FormValidationResult with two fieldErrors ' +
	                ...
	                'viewModel equals { id: "1", fullname: "", password: "123" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', password: '123' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #6 => should return a succeeded FormValidationResult with two fieldErrors first equals ' +
	                ...
	                'When passing one validation rule with key equals "fullname", two validations rules with ' +
	                'key equals "password" and ' +
	                'viewModel equals { id: "1", fullname: "john", password: "123" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john', password: '123' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #7 => should return a rejected promise ' +
	                'When passing one validation rule that contains an uncontrolled exception', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '' };
	                var thrownErrorMessage = 'Intentionally uncontrolled error, single field validation testing fullform validations';
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    throw new Error(thrownErrorMessage);
	                });
	                var promise = validationEngine.validateForm(viewModel);
	                expect(promise).to.eventually.be.rejected.and.notify(done);
	            });
	            it('Spec #8 => should not execute second validation if the first one fails', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var validationFn1 = function () { return ({
	                    type: 'REQUIRED',
	                    succeeded: false,
	                    errorMessage: 'Mandatory field'
	                }); };
	                var validationFn2 = function () { return ({
	                    type: 'USER_EXISTS',
	                    succeeded: false,
	                    errorMessage: 'User already exists'
	                }); };
	                var validationFn1Spy = sinon.spy(validationFn1);
	                var validationFn2Spy = sinon.spy(validationFn2);
	                var vm = { fullname: '' };
	                ...
	                validationEngine.validateForm(vm).then(function (validationResult) {
	        ...
	        describe('Group #2 => When calling validateForm and addFormValidation with async function', function () {
	            it('Spec #1 => should return a succeeded FormValidationResult with one formGlobalErrors equals ' +
	                ...
	                'When passing one global validation rule and viewModel equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Global form check Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #2 => should return a failed FormValidationResult with one formGlobalErrors equals ' +
	                ...
	                'When passing one global validation rule and viewModel equals { id: "1", fullname: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	            ...
	            it('Spec #3 => should return a succeeded FormValidationResult with two formGlobalErrors ' +
	                ...
	                'When passing two global validation rules and viewModel equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	                ...
	                validationEngine.addFormValidation(function (vm) {
	                    var minLength = (vm.fullname != null && vm.fullname.length >= 3);
	                    var errorInfo = (minLength) ? "" : "Global form check must be at least 3 characters";
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #4 => should return a failed FormValidationResult with two formGlobalErrors ' +
	                ...
	                'When passing two global validation rules and viewModel equals { id: "1", fullname: "jo" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'jo' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Global form check Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #5 => should return a failed FormValidationResult with two formGlobalErrors ' +
	                ...
	                'second equals { succeeded: false, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_MIN_LENGTH", errorMessage: "Global form check must be at least 3 characters" }' +
	                'When passing two global validation rules and viewModel equals { id: "1", fullname: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	        ...
	        describe('Group #3 => When calling validateForm, addFieldValidation and addFormValidation with async function', function () {
	            it('Spec #1 => should return a succeeded FormValidationResult with one fieldErrors and one formGlobalErrors' +
	                ...
	                'equals { id: "1", fullname: "john", address: "mystreet" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john', address: 'mystreet' };
	                validationEngine.addFieldValidation('address', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	                    validationResult.type = "REQUIRED";
	            ...
	            it('Spec #2 => should return a failed FormValidationResult with  one fieldErrors and one formGlobalErrors ' +
	                ...
	                'When passing one validation rule with key equals "address", global validation rule and viewModel ' +
	                'equals { id: "1", fullname: "", address: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', address: '' };
	                validationEngine.addFieldValidation('address', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #3 => should return a failed FormValidationResult with  one fieldErrors and one formGlobalErrors ' +
	                ...
	                'second equals { succeeded: false, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_REQUIRED", errorMessage: "Global form check Mandatory field" }' +
	                'When passing one validation rule with key equals "address", global validation rule and viewModel ' +
	                'equals { id: "1", fullname: "", address: "street" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', address: 'street' };
	                validationEngine.addFieldValidation('address', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #4 => should return a failed FormValidationResult with  one fieldErrors and one formGlobalErrors ' +
	                ...
	                'second equals { succeeded: true, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_REQUIRED", errorMessage: "" }' +
	                'When passing one validation rule with key equals "address", global validation rule and viewModel ' +
	                'equals { id: "1", fullname: "john", address: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john', address: '' };
	                validationEngine.addFieldValidation('address', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	                    var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                    var validationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #5 => should return a promise rejected when passing one faulty global validation rule', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john', address: '' };
	                var thrownErrorMessage = 'Intentionally global form uncontrolled exception';
	                validationEngine.addFormValidation(function (vm) {
	                    throw new Error(thrownErrorMessage);
	                });
	                var promise = validationEngine.validateForm(viewModel);
	        ...
	        describe('Group #4 => When calling validateForm, and addFieldValidation with sync function', function () {
	            it('Spec #1 => should return a failed FormValidationResult with one fieldErrors equals ' +
	                '{ succeeded: false, key: "fullname", type: "REQUIRED", errorMessage: "Mandatory Field" } ' +
	                'when passing one sync validation rule with key equals "fullname" and ' +
	                'viewModel equals { id: "1", fullname: "" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	            ...
	            it('Spec #2 => should return a succeeded FormValidationResult with one fieldErrors ' +
	                ...
	                'When passing one sync validation rule with key equals "fullname" and ' +
	                'viewModel equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	            ...
	            it('Spec #3 => should return a failed FormValidationResult with two fieldErrors first equals ' +
	                ...
	                'and viewModel equals { id: "1", fullname: "", password: ""  }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: '', password: "" };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	            ...
	            it('Spec #4 => should return a succeeded FormValidationResult with two fieldErrors first equals ' +
	                ...
	                'key equals "password" and viewModel equals { id: "1", fullname: "john", password: "123" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john', password: '123' };
	                validationEngine.addFieldValidation('fullname', function (value, vm) {
	                    var isFieldInformed = (value != null && value.length > 0);
	        ...
	        describe('Group #5 => When calling validateForm and addFormValidation with sync and async functions', function () {
	            it('Spec #1 => should return a succeeded FormValidationResult with one formGlobalErrors equals ' +
	                '{ succeeded: true, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_REQUIRED", errorMessage: "" }' +
	                'When passing one sync global validation rule and viewModel equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	            ...
	            it('Spec #3 => should return a succeeded FormValidationResult with two formGlobalErrors ' +
	                'first equals { succeeded: true, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_REQUIRED", errorMessage: "" }' +
	                'second equals { succeeded: true, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_MIN_LENGTH", errorMessage: "" }' +
	                'When passing one sync and other async global validation rules and viewModel equals { id: "1", fullname: "john" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'john' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
	            ...
	            it('Spec #4 => should return a failed FormValidationResult with two formGlobalErrors ' +
	                'first equals { succeeded: true, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_REQUIRED", errorMessage: "" }' +
	                'second equals { succeeded: false, key: "_GLOBAL_FORM_", type: "GLOBAL_FORM_MIN_LENGTH", errorMessage: "Global form check must be at least 3 characters" }' +
	                'When passing one sync and other async global validation rules and viewModel equals { id: "1", fullname: "jo" }', function (done) {
	                var validationEngine = new validationEngine_1.ValidationEngine();
	                var viewModel = { id: '1', fullname: 'jo' };
	                validationEngine.addFormValidation(function (vm) {
	                    var isFieldInformed = (vm.fullname != null && vm.fullname.length > 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    var validationEngine_1 = require("../validationEngine");
	    var entities_1 = require("../entities");
	    describe('lcFormValidation simple form', function () {
	        it('should return isValidationInProgress true if validations are inProgress', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = { id: '1', fullname: 'john' };
	            formValidationBase.addFieldValidation('fullname', function (value, vm) {
	                var isFieldInformed = (value && value.length > 0);
	                var errorInfo = (isFieldInformed) ? "" : "Mandatory field";
	                var validationResult = new entities_1.FieldValidationResult();
	                validationResult.type = "REQUIRED";
	                validationResult.succeeded = isFieldInformed;
	        ...
	        it('should return a validation error array with one item (field required) for the name field', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = { id: '1', fullname: 'john' };
	            formValidationBase.addFieldValidation('fullname', function (value, vm) {
	                var isFieldInformed = (value != null && value.length > 0);
	        ...
	        it('should return an empty validation array (field required) for the name field', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = { id: '1', fullname: 'john' };
	            formValidationBase.addFieldValidation('fullname', function (value, vm) {
	                var isFieldInformed = (value != null && value.length > 0);
	        ...
	        it('should return a promise reject error (validation throws unexpected error)', function (done) {
	            var formValidationBase = new validationEngine_1.ValidationEngine();
	            var viewModel = { id: '1', fullname: 'john' };
	            var thrownErrorMessage = "Intentionally uncontrolled error, single field validation testing trigger field validations";
	            formValidationBase.addFieldValidation('fullname', function (value, vm) {
	                throw new Error(thrownErrorMessage);
	            });
	            var promise = formValidationBase.triggerFieldValidation(viewModel, 'fullname', '');
	            expect(promise).to.eventually.be.rejected.and.notify(done);
	        });
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(91), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var validationsDispatcher_1 = require("../validationsDispatcher");
	    var entities_1 = require("../entities");
	    describe('ValidationsDispatcher', function () {
	        describe('Group #1 => When calling fireSingleFieldValidations', function () {
	            it('Spec #1 => should return undefined FieldValidationResult ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals undefined', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationsPerField = undefined;
	                var fieldValidationResultPromise = validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, validationsPerField);
	            ...
	            it('Spec #2 => should return undefined FieldValidationResult ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals null', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationsPerField = null;
	                var fieldValidationResultPromise = validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, validationsPerField);
	                fieldValidationResultPromise
	                    .then(function (fieldValidationResult) {
	                    expect(fieldValidationResult).to.be.undefined;
	            ...
	            it('Spec #3 => should return undefined FieldValidationResult ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals []', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationsPerField = [];
	                var fieldValidationResultPromise = validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, validationsPerField);
	                fieldValidationResultPromise
	                    .then(function (fieldValidationResult) {
	                    expect(fieldValidationResult).to.be.undefined;
	            ...
	            it('Spec #4 => should return succeeded FieldValidationResult and calls to successful validation function' +
	                ...
	                'equals successful validation function', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	                    fieldValidationResult.succeeded = true;
	                    return Promise.resolve(fieldValidationResult);
	                };
	                var validationFnSpy = sinon.spy(validationFn);
	                var eventsFilter = {};
	                var customParams = {};
	                var fieldValidation = {
	                ...
	                var validationsPerField = [fieldValidation];
	                var fieldValidationResultPromise = validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, validationsPerField);
	                fieldValidationResultPromise
	                    .then(function (fieldValidationResult) {
	                    expect(fieldValidationResult.succeeded).to.be.true;
	            ...
	            it('Spec #6 => should return failed FieldValidationResult and calls only to first validation function' +
	                ...
	                'second equals failed validation function', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn1 = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	                    fieldValidationResult.succeeded = false;
	                    return Promise.resolve(fieldValidationResult);
	                };
	                var validationFn2 = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	                    fieldValidationResult.succeeded = false;
	                    return Promise.resolve(fieldValidationResult);
	                };
	                var validationFnSpy1 = sinon.spy(validationFn1);
	                var validationFnSpy2 = sinon.spy(validationFn2);
	                var eventsFilter = {};
	                var customParams = {};
	                var fieldValidation1 = {
	                    validationFn: validationFnSpy1,
	                    eventsFilter: eventsFilter,
	                    customParams: customParams,
	                };
	                var fieldValidation2 = {
	                    validationFn: validationFnSpy2,
	                    eventsFilter: eventsFilter,
	                    customParams: customParams,
	                };
	                var validationsPerField = [fieldValidation1, fieldValidation2];
	                var fieldValidationResultPromise = validationsDispatcher_1.validationsDispatcher.fireSingleFieldValidations(vm, value, validationsPerField);
	                fieldValidationResultPromise
	                    .then(function (fieldValidationResult) {
	                    expect(fieldValidationResult.succeeded).to.be.false;
	            ...
	            it('Spec #7 => should return failed FieldValidationResult and calls only to first validation function' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals array with two items' +
	                'first equals failed validation function' +
	                'second equals successful validation function', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn1 = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #10 => should return undefined FieldValidationResult and calls to validation functions ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals array with one item ' +
	                'equals validation function resolving a fieldValidationResult equals undefined', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn = function (vm, value, customParams) {
	                    var fieldValidationResult = undefined;
	                    return Promise.resolve(fieldValidationResult);
	                };
	                var validationFnSpy = sinon.spy(validationFn);
	                var eventsFilter = {};
	            ...
	            it('Spec #11 => should return null FieldValidationResult and calls to validation functions ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals array with one item ' +
	                'equals validation function resolving a fieldValidationResult equals null', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn = function (vm, value, customParams) {
	                    var fieldValidationResult = null;
	                    return Promise.resolve(fieldValidationResult);
	                };
	                var validationFnSpy = sinon.spy(validationFn);
	                var eventsFilter = {};
	            ...
	            it('Spec #11 => should return empty FieldValidationResult and calls to validation functions ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals array with one item ' +
	                'equals validation function resolving a fieldValidationResult equals ""', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn = function (vm, value, customParams) {
	            ...
	            it('Spec #14 => should return failed and key equals "test1" FieldValidationResult and calls to first validation function ' +
	                'When passing vm equals undefined, value equals undefined and validationsPerField equals array with two items ' +
	                'first equals failed validation function' +
	                'second equals validation function resolving a fieldValidationResult equals undefined', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn1 = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('should pass customParams to its proper validationFunction', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn1 = function (vm, value, customParams) {
	                    var fieldValidationResult = new entities_1.FieldValidationResult();
	                ...
	                var validationFnSpy2 = sinon.spy(validationFn2);
	                var eventsFilter = {};
	                var customParams1 = { param1: 'param1' };
	                var customParams2 = { param2: 'param2' };
	                var fieldValidation1 = {
	                    validationFn: validationFnSpy1,
	                    eventsFilter: eventsFilter,
	        ...
	        describe('Group #2 => When calling fireAllFieldsValidations', function () {
	            it('Spec #1 => should return empty array' +
	                'When passing vm equals undefined, vmKeys equals undefined and validationFn equals undefined', function () {
	                var vm = undefined;
	                var vmKeys = undefined;
	                var validationFn = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFn);
	                expect(fieldValidationResultPromises).to.have.lengthOf(0);
	            });
	            it('Spec #2 => should return empty array' +
	                'When passing vm equals null, vmKeys equals null and validationFn equals undefined', function () {
	                var vm = null;
	                var vmKeys = null;
	                var validationFn = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFn);
	            ...
	            it('Spec #3 => should return empty array' +
	                'When passing vm equals "", vmKeys equals [] and validationFn equals undefined', function () {
	                var vm = "";
	                var vmKeys = [];
	                var validationFn = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFn);
	            ...
	            it('Spec #4 => should return empty array' +
	                'When passing vm equals { }, vmKeys as non empty array and validationFn equals undefined', function () {
	                var vm = {};
	                var vmKeys = ['fullname'];
	                var validationFn = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFn);
	            ...
	            it('Spec #5 => should return empty array when passing vm equals null, vmKeys as non empty array ' +
	                'and validationFn equals undefined', function () {
	                var vm = null;
	                var vmKeys = ['fullname'];
	                var validationFn = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFn);
	            ...
	            it('Spec #8 => should return empty array and it should not call to validationFn ' +
	                'when passing vm equals { }, vmKeys as non empty array and validationFn equals function', function () {
	                var vm = {};
	                var vmKeys = ['fullname'];
	                var validationFnSpy = sinon.spy();
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFnSpy);
	                expect(fieldValidationResultPromises).to.have.length(0);
	            ...
	            it('Spec #10 => should not return empty array with one item and it calls to validationFn ' +
	                'when passing vm equals { testVmProperty: "test" }, vmKeys equals [] and validationFn equals function', function () {
	                var vm = {
	                    testVmProperty: 'test'
	                };
	                var vmKeys = ['testVmProperty'];
	                var validationFnSpy = sinon.spy();
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireAllFieldsValidations(vm, vmKeys, validationFnSpy);
	        ...
	        describe('Group #3 => When calling fireGlobalFormValidations', function () {
	            it('Spec #1 => should return empty array ' +
	                'When passing vm equals undefined, validations equals undefined', function () {
	                var vm = undefined;
	                var validations = undefined;
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	                expect(fieldValidationResultPromises).to.have.length(0);
	            });
	            it('Spec #2 => should return empty array ' +
	                'When passing vm equals undefined, validations equals null', function () {
	                var vm = undefined;
	            ...
	            it('Spec #3 => should return empty array ' +
	                'When passing vm equals undefined, validations equals []', function () {
	                var vm = undefined;
	                var validations = [];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	                expect(fieldValidationResultPromises).to.have.length(0);
	            ...
	            it('Spec #4 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals undefined, validations equals array with one validationFn', function () {
	                var vm = undefined;
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	                expect(fieldValidationResultPromises).to.have.length(1);
	                expect(validationFnSpy.calledOnce).to.be.true;
	            ...
	            it('Spec #5 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals null, validations equals array with one validationFn', function () {
	                var vm = null;
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	            ...
	            it('Spec #6 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals "", validations equals array with one validationFn', function () {
	                var vm = '';
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	            ...
	            it('Spec #7 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals "test", validations equals array with one validationFn', function () {
	                var vm = 'test';
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	            ...
	            it('Spec #8 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals 1, validations equals array with one validationFn', function () {
	                var vm = 1;
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	            ...
	            it('Spec #9 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals function, validations equals array with one validationFn', function () {
	                var vm = function () {
	            ...
	            it('Spec #10 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals array, validations equals array with one validationFn', function () {
	                var vm = Array();
	                var validationFnSpy = sinon.spy();
	                var validations = [validationFnSpy];
	                var fieldValidationResultPromises = validationsDispatcher_1.validationsDispatcher.fireGlobalFormValidations(vm, validations);
	            ...
	            it('Spec #11 => should return array with one item and it calls to validationFn' +
	                'When passing vm equals object, validations equals array with one validationFn', function () {
	                var vm = {
	            ...
	            it('Spec #12 => should return rejected promise' +
	                ...
	                'and error management is set to default behavior for that validation fn', function (done) {
	                var vm = undefined;
	                var value = undefined;
	                var validationFn = function (vm, value, customParams) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(92), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var validationsResultBuilder_1 = require("../validationsResultBuilder");
	    var entities_1 = require("../entities");
	    describe('ValidationsResultBuilder ', function () {
	        describe('Group #1 => when calling buildFormValidationsResult ', function () {
	            it('Spec #1 => should returns new FormValidationResult equals { succeeded: false } ' +
	                'when passing fieldValidationResults equals undefined', function () {
	                var fieldValidationResults = undefined;
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.succeeded).to.be.false;
	            });
	            it('Spec #2 => should returns new FormValidationResult equals { succeeded: false } ' +
	                'when passing fieldValidationResults equals null', function () {
	                var fieldValidationResults = null;
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.succeeded).to.be.false;
	            });
	            it('Spec #3 => should returns new FormValidationResult equals { succeeded: false } ' +
	                'when passing fieldValidationResults equals empty', function () {
	                var fieldValidationResults = [];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.succeeded).to.be.false;
	            });
	            it('Spec #4 => should returns new FormValidationResult equals { succeeded: false } ' +
	                'when passing fieldValidationResults with one item equals { succeeded: false }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	                fieldValidationResult.succeeded = false;
	                var fieldValidationResults = [fieldValidationResult];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.succeeded).to.be.false;
	            });
	            it('Spec #5 => should returns new FormValidationResult equals { succeeded: true } ' +
	                'when passing fieldValidationResults with one item equals { succeeded: true }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	                fieldValidationResult.succeeded = true;
	                var fieldValidationResults = [fieldValidationResult];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	            ...
	            it('Spec #6 => should returns new FormValidationResult equals { succeeded: false } ' +
	                ...
	                'and second equals { succeeded: false }', function () {
	                var fieldValidationResult1 = new entities_1.FieldValidationResult();
	                fieldValidationResult1.succeeded = true;
	                var fieldValidationResult2 = new entities_1.FieldValidationResult();
	                fieldValidationResult2.succeeded = false;
	                var fieldValidationResults = [fieldValidationResult1, fieldValidationResult2];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.succeeded).to.be.false;
	            });
	            it('Spec #7 => should returns new FormValidationResult equals { succeeded: true } ' +
	                'when passing fieldValidationResults with two items first equals { succeeded: true } ' +
	                'and second equals { succeeded: true }', function () {
	                var fieldValidationResult1 = new entities_1.FieldValidationResult();
	                fieldValidationResult1.succeeded = true;
	                var fieldValidationResult2 = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #11 => should returns new FormValidationResult equals ' +
	                ...
	                'when passing fieldValidationResults with one item equals { key: "test" }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #12 => should returns new FormValidationResult equals ' +
	                ...
	                'when passing fieldValidationResults with one item equals { key: null }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #13 => should returns new FormValidationResult equals ' +
	                '{ fieldErrors: [] } with length equals 0 ' +
	                'when passing fieldValidationResults with one item equals { key: undefined }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #14 => should returns new FormValidationResult equals ' +
	                '{ fieldErrors: [] } with length equals 0 ' +
	                'when passing fieldValidationResults with one item equals { key: "" }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	            ...
	            it('Spec #15 => should returns new FormValidationResult equals ' +
	                '{ fieldErrors: [] } with length equals 0 ' +
	                'when passing fieldValidationResults with one item equals { key: "_GLOBAL_FORM_" }', function () {
	                var fieldValidationResult = new entities_1.FieldValidationResult();
	                fieldValidationResult.key = '';
	                var fieldValidationResults = [fieldValidationResult];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	            ...
	            it('Spec #21 => should returns new FormValidationResult equals ' +
	                ...
	                'and second equals null', function () {
	                var fieldValidationResult1 = new entities_1.FieldValidationResult();
	                fieldValidationResult1.key = 'test';
	                var fieldValidationResult2 = null;
	                var fieldValidationResults = [fieldValidationResult1, fieldValidationResult2];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.fieldErrors).to.have.length(1);
	                expect(result.fieldErrors[0].key).to.be.equal('test');
	            ...
	            it('Spec #22 => should returns new FormValidationResult equals ' +
	                '{ fieldErrors: [{ key: "test" }] } with length equals 1 ' +
	                'when passing fieldValidationResults with two item first equals { key: "test" }' +
	                'and second equals undefined', function () {
	                var fieldValidationResult1 = new entities_1.FieldValidationResult();
	                fieldValidationResult1.key = 'test';
	                var fieldValidationResult2 = undefined;
	                var fieldValidationResults = [fieldValidationResult1, fieldValidationResult2];
	                var result = validationsResultBuilder_1.validationsResultBuilder.buildFormValidationsResult(fieldValidationResults);
	                expect(result.fieldErrors).to.have.length(1);
	                expect(result.fieldErrors[0].key).to.be.equal('test');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    ...
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var ValidationParams = (function () {
	        function ValidationParams(vm, value, validationsPerField) {
	            this.vm = vm;
	            this.value = value;
	    ...
	    var ValidationDispatcher = (function () {
	        ...
	        ValidationDispatcher.prototype.fireSingleFieldValidations = function (vm, value, fieldValidations) {
	            var _this = this;
	        ...
	        ValidationDispatcher.prototype.fireSingleValidation = function (resolve, reject, validationParams, currentIndex) {
	            var _this = this;
	            ...
	            fieldValidation.validationFn(validationParams.value, validationParams.vm, fieldValidation.customParams)
	                .then(function (fieldValidationResult) {
	                if (_this.fieldValidationFailedOrLastOne(fieldValidationResult, currentIndex, validationParams.validationsPerField.length)) {
	                    resolve(fieldValidationResult);
	                }
	                else {
	                    currentIndex++;
	                    _this.fireSingleValidation(resolve, reject, validationParams, currentIndex);
	                }
	            }).catch(function () {
	                reject(currentIndex);
	            });
	        };
	        ValidationDispatcher.prototype.fieldValidationFailedOrLastOne = function (fieldValidationResult, index, numberOfItems) {
	            return !fieldValidationResult ||
	                !fieldValidationResult.succeeded ||
	                this.isLastElement(index, numberOfItems);
	        };
	        ValidationDispatcher.prototype.isLastElement = function (index, length) {
	            return index === (length - 1);
	        };
	        ValidationDispatcher.prototype.fireAllFieldsValidations = function (vm, fieldsToValidate, validationFn) {
	        ...
	        ValidationDispatcher.prototype.fireGlobalFormValidations = function (vm, validations) {
	        ...
	        ValidationDispatcher.prototype.areParametersDefined = function () {
	            var parameters = [];
	            for (var _i = 0; _i < arguments.length; _i++) {
	                parameters[_i] = arguments[_i];
	            }
	            return parameters.every(function (parameter) { return parameter; });
	        };
	    ...
	    exports.validationsDispatcher = validationsDispatcher;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(82)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    var ValidationsResultBuilder = (function () {
	        ...
	        ValidationsResultBuilder.prototype.buildFormValidationsResult = function (fieldValidationResults) {
	            var formValidationResult = new entities_1.FormValidationResult();
	            if (fieldValidationResults && fieldValidationResults.length > 0) {
	                ...
	                formValidationResult.succeeded = filteredFieldValidationResults.every(function (fvr) { return fvr.succeeded; });
	                formValidationResult.fieldErrors = filteredFieldValidationResults.filter(function (fvr) { return fvr.key !== consts_1.consts.globalFormValidationId; });
	                formValidationResult.formGlobalErrors = filteredFieldValidationResults.filter(function (fvr) { return fvr.key === consts_1.consts.globalFormValidationId; });
	            }
	            return formValidationResult;
	        };
	        ValidationsResultBuilder.prototype.removeUndefinedValidationResults = function (fieldValidationResults) {
	            return fieldValidationResults.filter(function (fvr) { return fvr !== undefined &&
	                fvr !== null; });
	        };
	        ValidationsResultBuilder.prototype.setGlobalKeyToEmptyKeys = function (fieldValidationResults) {
	            fieldValidationResults.forEach(function (fieldValidationResult) {
	                if (!fieldValidationResult.key) {
	                    fieldValidationResult.key = consts_1.consts.globalFormValidationId;
	                }
	            });
	        };
	        return ValidationsResultBuilder;
	    }());
	    exports.ValidationsResultBuilder = ValidationsResultBuilder;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (factory) {
	    if (typeof module === "object" && typeof module.exports === "object") {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(81), __webpack_require__(66)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	})(function (require, exports) {
	    "use strict";
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var entities_1 = require("./entities");
	    exports.FormValidationResult = entities_1.FormValidationResult;
	    exports.FieldValidationResult = entities_1.FieldValidationResult;
	    var baseFormValidation_1 = require("./baseFormValidation");
	    exports.createFormValidation = baseFormValidation_1.createFormValidation;
	    var rules_1 = require("./rules");
	    exports.Validators = rules_1.Validators;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx            = __webpack_require__(25)
	  ...
	  , aFunction      = __webpack_require__(14)
	  , forOf          = __webpack_require__(38)
	  , isIterable     = __webpack_require__(146)
	  , $iterCreate    = __webpack_require__(74)
	  , step           = __webpack_require__(102)
	  , isObject       = __webpack_require__(5)
	  , toIObject      = __webpack_require__(12)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1)
	  , define  = __webpack_require__(135);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(TO_PRIMITIVE in proto))__webpack_require__(16)(proto, TO_PRIMITIVE, __webpack_require__(154));
